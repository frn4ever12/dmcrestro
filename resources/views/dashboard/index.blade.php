                ...
                <ul class="products-list product-list-in-card">
                    <li class="item">
                        ...
                        <div class="product-info">
                            <a href="#" class="product-title">Order #12345
                                <span class="badge badge-warning float-right">Pending</span>
                            </a>
                            <span class="product-description">Chicken Momo x 2, Veg Momo x 1</span>
                        </div>
                    </li>
                    <li class="item">
                        <div class="product-img">
                        ...
                        <div class="product-info">
                            <a href="#" class="product-title">Order #12346
                                <span class="badge badge-success float-right">Completed</span>
                            </a>
                            <span class="product-description">Chicken Biryani x 1</span>
                        </div>
                    </li>
                </ul>
            </div>
